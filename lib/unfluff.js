...
//TODO: Fork repo and include as module
void function () {
  var cheerio,
    cleaner,
    extractor,
  ...
  require('cheerio-get-css-selector').init(cheerio);
  ...
  unfluff.lazy = function (html, language) {
    return {
      selector: function () {
        ...
        articleNode = getTopNode.call(this, doc, this.lang());
        articleSelector = articleNode.length
          ? articleNode.getUniqueSelector()
          : null;
